# Install script for directory: /Users/russelljohnson/dev/sdl_core/src/components/application_manager/rpc_plugins/sdl_rpc_plugin
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE SHARED_LIBRARY PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE FILES "/Users/russelljohnson/dev/sdl_core/compiled_packages/macos/src/components/application_manager/rpc_plugins/sdl_rpc_plugin/libsdl_rpc_plugin.dylib")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/libsdl_rpc_plugin.dylib" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/libsdl_rpc_plugin.dylib")
    execute_process(COMMAND "/usr/bin/install_name_tool"
      -id "libsdl_rpc_plugin.dylib"
      ...
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/libsdl_rpc_plugin.dylib")
    execute_process(COMMAND /usr/bin/install_name_tool
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/Library/Developer/CommandLineTools/usr/bin/strip" -x "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/libsdl_rpc_plugin.dylib")
    endif()
  endif()
endif()
